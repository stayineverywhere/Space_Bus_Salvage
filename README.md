...
본 프로젝트는 **Lethal Company**의 협동 인양 및 위험-보상 구조에서 영감을 받아 제작되었습니다.

다만, Space Bus Salvage는 단순한 유사 작품이 아닌 다음과 같은 차별점을 목표로 개발되었습니다.

* 우주 버스를 중심으로 한 이동 및 생존 시스템
* 전리품 가치와 연동되는 저주(Curse) 시스템
* 계약 기반의 장기 진행 구조
* 다양한 행성 환경과 기후 요소
* 솔로 플레이에 최적화된 공포 탐사 경험
